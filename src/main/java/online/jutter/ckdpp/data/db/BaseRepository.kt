package online.jutter.ckdpp.data.db

import online.jutter.ckdpp.common.HibernateUtils
...
open class BaseRepository<ENT> {
     ...
     * Вставка в базу сущности [ENT].
     */
    open fun <CUSTOM_ENT> insertOther(entity: CUSTOM_ENT) = executeTransaction {
        persist(entity)
    }
    ...
    inline fun <reified O_ENT> Session.getOtherById(id: Serializable): O_ENT {
        return this.get(O_ENT::class.java, id)
    }
